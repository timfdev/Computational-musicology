...
<!-- function fade2(){ -->
<!-- var colors = ["#000000", "#9cc3d5ff", '#800080', '#9cc3d5ff']; -->
<!-- var counter = 0; -->
<!-- if (counter < 4){    -->
<!--   counter++; -->
<!-- } else{ -->
...
<!-- setInterval(function() { -->
<!-- var p = $("#slideshow").style.backgroundColor = colors[counter]; -->
<!-- p.queue function() { -->
<!--   $("#slideshow").fadeOut(2000) -->
<!--   $("#slideshow").style.backgroundColor = colors[counter]; -->
<!-- } -->
